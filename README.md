...
- Comment Service
  - commentListGameService(gameid)
  - commentListEventService(eventid)
  - commentAddGameService(gameid, newComment)
  - commentAddEventService(eventid, newComment)
  - commentDeleteService(commentid)
  - commentModifyService(commentid, updateContent)
